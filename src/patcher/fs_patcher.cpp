...
DECL(int, FSInit, void)
{
    ...
    if ((int)bss_ptr == 0x0a000000)
    {
        ...
        __os_snprintf(bss.mount_base, sizeof(bss.mount_base), "%s/%08x%08x", SD_GAMES_PATH,(unsigned int)(cosAppXmlInfoStruct.title_id >> 32), (unsigned int)(cosAppXmlInfoStruct.title_id & 0xFFFFFFFF));
...
DECL(int, FSAddClientEx, void *pClient, int unk_param, int error)
{
    int res = real_FSAddClientEx(pClient, unk_param, error);
